...
private:
	...
	static short _ReadMainMenueOption()
	{
		...
		short Choice = clsInputValidate::ReadShortNumberBetween(1, 10, "Please enter Number between 1 to 10? ");
		return Choice;
	}
	...
	static void _PerfromUsersManageMenueOption(enMainMenueOptions MainMenueOption)
	{
...
public:
	...
	static void ShowMainMenue()
	{
		...
		_PerfromUsersManageMenueOption((enMainMenueOptions)_ReadMainMenueOption());
	}
